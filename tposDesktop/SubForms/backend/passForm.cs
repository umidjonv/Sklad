...
namespace tposDesktop
{
    public partial class passForm : DesignedForm
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                rows = table.Select("username='" + UserValues.CurrentUser + "' and role='" + UserValues.role + "'");
            }else
            {
                rows = table.Select("username='" + UserValues.CurrentUser + "' and password='" + hash + "' and role='" + UserValues.role + "'");
            }
